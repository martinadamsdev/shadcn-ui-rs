...
use gpui::{
    deferred, div, prelude::*, px, AnyElement, App, ClickEvent, Div, ElementId, IntoElement,
    KeyDownEvent, MouseDownEvent, ParentElement, RenderOnce, SharedString, Stateful, Styled, Window,
};
        ...
        div()
            ...
            .child(
                div()
                    .id(self.id.clone())
                    .cursor_pointer()
                    .when_some(on_open_change.clone(), move |el: Stateful<Div>, on_open_change| {
            ...
            .when(open, |el: Div| {
                let overlay = div()
                    ...
                    .p(px(16.0))
                    .min_w(px(220.0))
                    .when_some(on_open_change.clone(), |el: Stateful<Div>, on_open_change| {
