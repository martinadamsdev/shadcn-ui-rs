...
use gpui::{
    deferred, div, prelude::*, px, AnyElement, App, Div, ElementId, IntoElement, ParentElement,
    RenderOnce, SharedString, Stateful, Styled, Window,
};
...
impl RenderOnce for HoverCard {
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        div()
            ...
            .when(self.open, |el: Stateful<Div>| {
                let overlay = div()
