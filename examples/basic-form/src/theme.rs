//! Self-contained theme module for the basic-form example.
//!
//! This is a standalone copy of the shadcn-ui-rs theme system with the zinc
//! preset inlined. In a real project this would be generated by the CLI.
